...
const SingleProduct = () => {
  ...
  return (
    <>
      <div className="hidden lg:flex w-full min-h-screen font-kanit">
        {isLoading ? (
          ...
          <div className="flex">
            <div className="w-fit h-full px-8 py-3">
              ...
              <div className="w-[650px] h-fit border rounded-md my-3 border-gray-400">
                ...
                <div className="px-2  flex justify-between">
                  <div className="flex">
                    ...
                    <div className="flex justify-center ml-1 items-center font-semibold ">
              ...
              <div className="py-2 px-1 font-bold">
                ...
                <div className="flex px-2 mx-1 ">
                  {relatedProducts.map((item, index) => (
                    <div key={index} className="w-[300px] h-[250px] rounded-md mx-1">
                      ...
                      <div className="text-[15px] flex justify-start px-3">
                        {item.product_title.substring(0, 30) + "..."}
                      </div>
                      <div className="text-[14px] flex py-1 text-gray-600/80 px-3">
                        <div>Current Bid</div>
                        <div className="ml-1">
            ...
            <div className="py-4 text-[#313131] w-[700px]">
              ...
              <div className="py-2">
                <div className="w-full h-fit rounded-md px-2 border border-gray-300">
                  <div className="px-3 py-2 text-[#313131] font-semibold">
                    Product Description
                  </div>
